...
public class UserController {
	...
	@PostMapping
	public ResponseEntity<UserDto> createNewUser(@RequestBody @Valid RegistrationUserDto registrationUserDto) {
	...
	@GetMapping
	public ResponseEntity<Page<UserDto>> findAll(@RequestParam(value = "page", defaultValue = "0") int page,
